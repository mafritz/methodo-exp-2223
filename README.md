...
-   [Lire et interpréter des contributions expérimentales *primaires*](https://github.com/mafritz/methodo-exp-2223/blob/main/sources-experimentales-primaires/lire-et-interpreter-sources-experimentales-primaires.pdf)
...
|    Horaire    | Contenus                     |
|:-------------:|------------------------------|
| 14h00 - 14h30 | Retour P5 et Informations P6 |
| 14h30 - 16h00 | Workshop avec R              |

### Retour P5 et informations P6

Cette partie du cours a dû être adaptée. Elle prévoiait normalement les fondements statistiques de la méthode expérimentale :
...
-   **La vidéo de la présentation est disponible dans l'espace Moodle du cours**
...
Le matériel et les instructions pour cette partie du cours sont disponibles dans le dossier `fondements-statistiques/scripts-workshop`. À faire en salle de classe par groupes :

-   **00_installation.R avant de commener**

-   **05_t-test_single.R**

-   **06_t-test_multiple_simulation.R**

Ensuite vous pouvez choisir les autres scripts selon vos intérêts ou besoins de votre expérience.

Le README de ce dossier propose les instructions pour suivre le workshop:
