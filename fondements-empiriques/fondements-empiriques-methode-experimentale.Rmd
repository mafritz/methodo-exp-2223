...
![Design inter-sujets. Les participant-es sont exposé-es seulement à une modalité de la VI ou des VIs.](images/design-inter-sujets.png){width="50%"}
...
```{r pre-post-graph, fig.align="center", fig.cap="Exemple des résultats d'un plan inter-sujets avec pré-test et post-test", fig.height=4}
pre_post_plot
```
...
-   Délimiter les contraintes déontologiques
