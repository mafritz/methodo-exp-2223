...
Du côté des technologies éducatives on peut trouver les *Learning Management Systems*, les principes multimédia, les jeux vidéos pédagogiques, et ainsi de suite. Il s'agit donc d'outils ou scénarios techno-pédagogiques qui visent à donner aux personnes les moyens pour apprendre. L'apprentissage peut être à son tour divisé dans des processus tels que la compréhension, la capacité a collaborer, la résolution de problèmes, et ainsi de suite. La technologie éducative couvre un large éventail de situations d'apprentissages et de phénomènes qui peuvent être améliorés grâce à la scénarisation d'outils techno-pédagogiques.

La relation entre technologie éducative peut enfin être déterminée ou influencée par une multitude de facteurs relatifs aux outils, aux personnes, au contexte, et ainsi de suite. Parmi les facteurs qui peuvent intervenir dans cette relation figurent les connaissances préalables, l'expérience utilisateur dans l'appropriation et utilisation des technologies, le niveau d'expertise, et d'autres encore.

La recherche expérimentale en technologie éducative consiste donc principalement à formuler des hypothèses sur les relations causales entre les technologie éducatives et les processus d'apprentissage, ainsi que sur les effets de facteurs qui peuvent faciliter, entraver, médier ou modérer ces effets. Le schéma proposé ici est seulement indicatif, car le même phénomène peut assumer, selon la question de recherche envisagé, le rôle d'intervention, de facteur intervenant, ou de phénomène d'intérêt. Par exemple, la présence sociale [@lowenthalSearchBetterUnderstanding2017; @jezegouCreerPresenceDistance2010] peut tout à fait joueur les trois rôles:

1.  Intervention: on peut imaginer un environnement médiatisé par ordinateur qui possède ou pas des fonctionnalités qui permettent de *percevoir* la présence d'autres apprenant-es
