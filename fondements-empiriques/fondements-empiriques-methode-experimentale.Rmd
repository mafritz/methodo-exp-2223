...
![Design inter-sujets. Les participant-es sont exposé-es seulement à une modalité de la VI ou des VIs.](images/design-inter-sujets.png){width="47%"}
...
![Design intra-sujets. Les participant-es sont exoposé-es à toutes les modalités de la VI ou des VIs, souvent dans une séquence différente pour éviter des effets d'ordre.](images/design-intra-sujets.png){width="60%"}
