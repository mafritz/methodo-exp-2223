...
3.  Les variable bloquées/neutralisées ou contrôlées/ajustées
...
-   $A_i$ définit les instruments auxiliaires nécessaire à l'expérience, comme par exemple l'équipement technique
