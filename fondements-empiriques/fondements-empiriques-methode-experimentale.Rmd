...
1.  Intervention: on peut imaginer un environnement médiatisé par ordinateur qui possède ou pas des fonctionnalités qui permettent de *percevoir* la présence des autres apprenant-es
2.  Facteur intervenant: dans certains conditions, la présence d'autres personnes dans le même environnement est une condition nécessaire au design techno-pédagogique (e.g. collaboration médiatisée par ordinateur)
3.  Phénomène d'intérêt: la présence sociale peut enfin représenter la *mesure* de l'efficacité d'une intervention techno-pédagogique dont l'objectif pourrait consister justement dans une meilleure perception de la présence des autres dans un environnement médiatisé.
