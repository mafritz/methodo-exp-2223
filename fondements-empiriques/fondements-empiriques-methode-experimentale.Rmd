...
La recherche expérimentale se traduit souvent par des formulations des questions de recherche qui suggèrent -- avec différents degrés de *précaution* selon le caractère exploratoire ou confirmatoire vu plus haut -- des mécanismes causaux potentiels entre l'intervention et l'évolution du phénomène d'intérêt. Dans une question de recherche expérimentale, il est important de prêter une attention particulière aux caractéristiques suivantes:
...
La plupart des recherches qui adoptent la méthode expérimentale s'intéressent donc à des mécanismes causaux potentiels qui pourraient expliquer l'effet de l'intervention $X$ sur un phénomène $Y$.
...
-   S'adresse de manière plus large à la question de recherche et aux éventuels mécanismes causaux postulés par les hypothèses théoriques.
...
La méthode expérimentale est souvent prise à exemple comme la méthode phare dans une perspective de corroboration ou de falsification d'une théorie ou d'une hypothèse [@uyguntuncEpistemicPragmaticFunction2023; @meehlAppraisingAmendingTheories1990; @mayoStatisticalInferenceSevere2018; @maxwell2017]. Grâce à la comparaison systématique entre deux ou plusieurs *univers contre-factuels*, on peut établir à quel point les résultats renforcent ou contredisent des postulats théoriques/causaux. Cette capacité doit néanmoins être pondérée en fonction des nombreuses implications enchaînées par une expérience avec valence théorique. Par exemple, @meehlAppraisingAmendingTheories1990 propose une formule logique lorsque le test d'une théorie/hypothèse est effectué:
