...
Cet exemple permet également d'aborder différentes modalités d'attribution aléatoire: la randomisation avec remplacement, sans remplacement, et la randomisation bloquée.
...
![Design inter-sujets. Les participant-es sont exposé-es seulement à une modalité de la VI ou des VIs.](images/design-inter-sujets.png){width="45%"}
