...
Une expérience est un écosystème complexe d'éléments qui s'influencent mutuellement. On peut identifier 4 étapes principales dans une expérience:
...
La recherche expérimentale se traduit souvent par des formulations des questions de recherche qui suggèrent -- avec différents degrés de *précaution* selon le caractère exploratoire ou confirmatoire vu plus haut -- des mécanismes de causalité potentiels entre l'intervention et l'évolution du phénomène d'intérêt. Dans une question de recherche expérimentale, il est important de prêter une attention particulière aux caractéristiques suivantes:
...
La prochaine étape s'intéresse plus spécifiquement à ce dernier point.
