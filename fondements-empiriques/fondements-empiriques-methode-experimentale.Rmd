...
On peut imaginer que dans une expérience qui porte sur l'effet du support du matériel d'accompagnement à un cours sur l'apprentissage, l'hypothèse théorique sera traduite sur la base de l'effet des modalités/conditions de la VI (lecture d'un texte, enregistrement d'un cours ex-cathedra de 30 minutes, et vision de 3 capsules vidéos de 5 minutes chacune) sur la mesure de l'apprentissage identifiée comme le score à un quiz de compréhension sur les contenus. Une hypothèse opérationnelle possible consisterait par exemple à l'attente d'une distribution des scores au test de compréhension (VD) autour des moyennes des conditions expérimentales ordonnée de la manière suivante:
