...
Le tableau suivant affiche les premières 10 observations d'un jeu de données avec ces cractéristiques.
...
Tableau des résultats de la régression ordinale.
...
Graphique de la régression ordinale.
...
Comparaison avec le même modèle qui utilise une régression linéaire multiple.
